...
const MEMBERSHIPS = {
    ...
    "reseller-membership": {
        itemId: [
            { itemSlug: "reseller-6m", itemName: "Reseller 6 Months", sellingPrice: 500 },
            { itemSlug: "reseller-12m", itemName: "Reseller 12 Months", sellingPrice: 900 },
        ],
    },
};
...
const OTTS = {
    ...
    netflix: {
        itemId: [{ itemSlug: "nf-1m", itemName: "Netflix 1m", sellingPrice: 105 }],
    },
    spotify: {
...
const BGMI_CONFIG = {
    itemId: [
        { itemSlug: "bgmi-60-uc", itemName: "60 UC", sellingPrice: 72 },
        { itemSlug: "bgmi-325-uc", itemName: "325 UC", sellingPrice: 360 },
        { itemSlug: "bgmi-660-uc", itemName: "660 UC", sellingPrice: 700 },
        { itemSlug: "bgmi-1800-uc", itemName: "1800 UC", sellingPrice: 1760 },
        { itemSlug: "bgmi-3850-uc", itemName: "3850 UC", sellingPrice: 3600 },
        { itemSlug: "bgmi-8100-uc", itemName: "8100 UC", sellingPrice: 7200 },
    ],
};
