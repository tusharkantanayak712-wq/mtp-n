    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div className="space-y-1.5">
          <label className="text-[10px] font-black uppercase tracking-widest text-[var(--muted)] ml-1 opacity-60">Character ID</label>
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative group">
            ...
            >
              ...
              <option value="os_asia" className="bg-[var(--card)] text-white font-medium">OS Asia</option>
              <option value="os_cht" className="bg-[var(--card)] text-white font-medium">OS CHT</option>
              <option value="os_euro" className="bg-[var(--card)] text-white font-medium">OS Euro</option>
              <option value="os_sea" className="bg-[var(--card)] text-white font-medium">OS SEA</option>
              <option value="os_usa" className="bg-[var(--card)] text-white font-medium">OS USA</option>
            </select>
          </div>
        </div>
      </div>
