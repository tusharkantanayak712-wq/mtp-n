      ...
      <div className="relative group">
        ...
        <div className="relative bg-[var(--card)]/80 backdrop-blur-3xl border border-white/10 rounded-2xl p-1.5 pr-2 shadow-[0_15px_40px_rgba(0,0,0,0.2)] flex items-center justify-between gap-2 overflow-hidden ring-1 ring-white/10">
          ...
          <div className="flex items-center gap-2 md:gap-3 min-w-0 flex-1 relative z-10 ms-1">
            ...
            <div className="flex flex-col min-w-0">
              <div className="flex items-center gap-1.5 mb-0.5">
                <h2 className="text-[9px] md:text-[10px] font-black text-[var(--foreground)] tracking-tight leading-none truncate opacity-60 lowercase">
                ...
                <span className="hidden sm:flex items-center gap-1 text-[8px] font-bold text-emerald-500 bg-emerald-500/10 px-1.5 py-0.5 rounded-full border border-emerald-500/20">
                  <FiCheck size={8} /> instant delivery
                </span>
              </div>
          ...
          <div className="flex flex-col items-end shrink-0">
              ...
              <AnimatePresence mode="wait">
                {redirecting ? (
                  ...
                  >
                    ...
                    <span className="text-[10px] md:text-xs font-black uppercase tracking-widest lowercase">wait</span>
                  </motion.div>
                ) : (
                  <motion.div
                    key="content"
                    ...
                    className="flex items-center gap-2"
                  >
                    <span className="text-xs md:text-sm font-[1000] uppercase tracking-widest">Buy Now</span>
                    <div className="bg-[var(--background)] text-[var(--foreground)] w-5 h-5 rounded-full flex items-center justify-center transition-transform group-hover/btn:translate-x-1 duration-500 flex-shrink-0">
                      <FiArrowRight size={12} fill="currentColor" />
                    </div>
                  </motion.div>
                )}
              </AnimatePresence>
            ...
            <div className="flex items-center gap-0.5 opacity-30 mt-0.5 pe-1">
              <FiShield size={7} className="text-[var(--accent)]" />
              <span className="text-[6px] font-black uppercase tracking-[0.1em] text-[var(--foreground)] lowercase">secure gateway</span>
            </div>
          </div>
